...
interface IPinpad {
     ...
     * @brief 下装工作密钥
     *
	 * @param keyType - 下装工作密钥类型 | select the workkey type
	 *     |---1-MAC key, 2-PIN key, 3-TD key
	 *     |---5-(SM4)MAC key, 6-(SM4)PIN key, 7-(SM4)TD key
	 *     |---9-(AES)MAC key, 10-(AES)PIN key, 11-(AES)TD key
	 * @param mkId - 解密工作密钥的主密钥ID | the id of master key for decrypt work key
	 * @param wkId - 下装密钥存储ID | set the workkey id (index 0~99)
	 * @param decKeyType - 解密密钥类型 | select decrypt key type
	 *     |---0-3DES master key
	 *     |---1-transport key
	 *     |---2-SM4 master key
	 *     |---3-AES master key
	 ...
	 * @param data - 计算MAC的数据 | the source date
	 * @param desType - 加密类型 | encrypt type
     * |--0x00-des
     * |--0x01-3des
     * |--0x02-sm4
     * |--0x03-aes
     ...
     * <ul>
     * <li>pinLimit(byte[]) the valid length(s) array of the PIN (such as {0,4,5,6} means the valid length is 0, 4 ~6)</li><BR>
     ...
     * @param globalParam - set global display (if set null, 0~9 are Arabic numerals and confirm/backspace button are english display)
     * <ul>
     *     <li>Display_One(String)</li><BR>
     *     <li>Display_Two(String)</li><BR>
     *     <li>Display_Three(String)</li><BR>
     *     <li>Display_Four(String)</li><BR>
     *     <li>Display_Five(String)</li><BR>
     *     <li>Display_Six(String)</li><BR>
     *     <li>Display_Seven(String)</li><BR>
     *     <li>Display_Eight(String)</li><BR>
     *     <li>Display_Nine(String)</li>
     *     <li>Display_Zero(String)</li>
     *     <li>Display_Confirm(String)</li>
     *     <li>Display_BackSpace(String)</li>
     ...
     * <ul><BR>
     * <li>TYPE_DES - 0x00 DES Type </li><BR>
     * <li>TYPE_3DES - 0x01 3DES Type </li><BR>
     * <li>TYPE_SM4 - 0x02 SM4 Type</li><BR>
     * <li>TYPE_AES - 0x03 AES Type</li><BR>
     * </ul>
     ...
     *
      * @return bundle
      * <ul><BR>
      *     <li>publicKey(string)</li><BR>
      *     <li>privateKey(string)</li><BR>
      * </ul><BR>
     * \en_e
     * \code{.java}
     * \endcode
    ...
    * @param bundle
    * <ul><BR>
    *     <li>prikey(byte[])</li> - the private key<BR>
    *     <li>data(byte[])</li> - the data want to sign<BR>
      * </ul>
    ...
    * */
     ...
     * <ul><BR>
     *     <li>pinLimit(byte[]) the valid length(s) array of the PIN (such as 0,4,5,6 means the valid length is 0, 4 ~6)</li><BR>
     *     <li>timeout(int) the timeout, second</li><BR>
     *     <li>isOnline(boolean) - is a online PIN</li><BR>
     *     <li>pan(String) - the pan for encrypt online PIN</li><BR>
     ...
     * <ul><BR>
     * <li>0x00 MK/SK encrypt </li><BR>
     * <li>0x01 MK/SK decrypt </li><BR>
     * </ul><BR>
     * @param desType the type of encrypt or decrypt
     * <ul><BR>
     * <li>TYPE_DES - 0x00 DES Type | </li><BR>
     * <li>TYPE_3DES - 0x01 3DES Type(EBC) | </li><BR>
     * <li>TYPE_SM4 - 0x02 SM4 Type | </li><BR>
     * <li>TYPE_AES - 0x03 AES Type| </li><BR>
     * <li>TYPE_SM2_PUBKEY - 0x04 SM2 Type(use public key) | </li><BR>
     * <li>TYPE_SM2_PRIVKEY - 0x05 SM2 Type(use private key) | </li><BR>
     * <li>TYPE_3DES - 0x06 3DES Type(CBC, initVec = 00000000) | </li><BR>
     * </ul><BR>
	 * @param key the source key
	 * @param data the source date
     *
     ...
     * <li>TYPE_SM2_PUBKEY - 0x04 SM2 Type(use public key) | </li>
     * <li>TYPE_SM2_PRIVKEY - 0x05 SM2 Type(use private key) | </li>
     * <li>TYPE_3DES - 0x06 3DES Type(CBC) | </li>
     * </ul>
	 * @param key - 计算key | the source key
	 * @param data - 计算数据 | the source date
     ...
     * <li>TYPE_SM2_PUBKEY - 0x04 SM2 Type(use public key) </li><BR>
     * <li>TYPE_SM2_PRIVKEY - 0x05 SM2 Type(use private key) </li><BR>
     * <li>TYPE_3DES - 0x06 3DES Type(CBC) </li><BR>
     * </ul>
	 * @param key the source key
	 * @param data the source date
